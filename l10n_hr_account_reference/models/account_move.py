...
class AccountMove(models.Model):
    ...
    def _get_default_properties(self):
        ...
        properties = self.env['ir.property'].sudo().search(
            [('fields_id', 'in', fields.ids), ('res_id', '=', False)]
        )
        res = {}
        for p in properties:
    ...
    def pnbr_get(self):
        ...
        P1 = getP1_P4data(self, self.journal_id.property_l10n_hr_P1_pnbr, default_properties)
        P2 = getP1_P4data(self, self.journal_id.property_l10n_hr_P2_pnbr, default_properties)
        P3 = getP1_P4data(self, self.journal_id.property_l10n_hr_P3_pnbr, default_properties)
        P4 = getP1_P4data(self, self.journal_id.property_l10n_hr_P4_pnbr, default_properties)
